  ...
  return (
    <footer>
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-12 col-md-4">
            ...
            <ul className="contact-info">
              ...
              <a href="https://github.com/MiguelAngel1DAM/Proyecto-Tema-6.git">Enlace a GitHub</a></li>
        ...
        <p>© 2023 JBL Todos los derechos reservados Política de Privacidad y Cookies | Condiciones de Venta</p>
      </div>
    </footer>
  );
}
